...
df = pd.read_csv("../Data/klines_BTCUSDC_1m_from_beginning_to_now.csv")
...
df_2025 = df[df['open_time'] >= '2025-09-01']

# Exporter le résultat
df_2025.to_csv("../Data/klines_BTCUSDC_1m_from_2025_09_to_now.csv", index=False)
